    ...
    return (
        <section className="mt-12 p-4 bg-gradient-to-b from-gray-200 to-white md:p-8">
            <div className="flex justify-between flex-wrap-reverse gap-4">
                <p className="md:w-1/2 animate animate_center">
            ...
            <Link to="/about" className="animate animate_center my-6 cursor-pointer border-b-2 border-transparent duration-200 inline-block hover:border-black hover:font-bold hover:translate-x-1">More About Us</Link>
