...
const AboutUs = () => {
    return (
        <section className="mt-12 p-4 bg-gradient-to-b from-gray-200 to-white md:p-8">
            ...
            <Link to="/about" className="my-6 cursor-pointer border-b-2 border-transparent duration-150 inline-block hover:border-black hover:font-bold">More About Us</Link>
