        ...
        <>
            <header className="bg-headerImg bg-cover bg-right h-svh">
                <section className="bg-white/5 w-full h-svh">
                    <div className="w-10/12 text-center mx-auto pt-40">
                        <div className="w-4/5 md:w-3/4 text-xl text-blue-800 text_shadow md:text-3xl lg:text-5xl font-mono font-bold mx-auto">
